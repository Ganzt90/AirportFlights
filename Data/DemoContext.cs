...
public partial class DemoContext : DbContext
{
    ...
    public virtual DbSet<FlightsRoute> FlightsRoutes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FlightsRoute>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("flights_routes", "bookings");
